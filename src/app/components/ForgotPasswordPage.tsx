...
const translations = {
  vi: {
    ...
    confirm: 'Xác nhận',
    forgotUsername: 'Bạn quên tên đăng nhập?',
...
export default function ForgotPasswordPage({ language }: ForgotPasswordPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!showCodeInput) {
      ...
      // Mock verification - redirect to reset password
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 border border-gray-100">
          <h2 className="text-2xl text-gray-900 mb-6">{t.forgotPasswordTitle}</h2>
          ...
          <div className="mt-6 text-center space-y-2">
            <Link to="/forgot-username" className="text-sm text-red-600 hover:text-red-700 block">
              {t.forgotUsername}
            </Link>
            <button
